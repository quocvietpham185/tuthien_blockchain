...
export default function Transactions({ contractHooks }) {
  ...
  const summary = transactions.reduce(
    (acc, tx) => {
      if (tx.txType === "DONATE") acc.donations += 1;
      if (tx.txType === "CREATE") acc.creates += 1;
      if (tx.txType === "WITHDRAW") acc.withdrawals += 1;
      if (tx.txType === "REFUND") acc.refunds += 1;
      if (tx.txType === "DONATE") acc.totalEth += parseFloat(tx.amount) || 0;
      return acc;
    },
    { donations: 0, creates: 0, withdrawals: 0, refunds: 0, totalEth: 0 }
  );
  ...
  return (
    <div className="page-content">
      <div className="container" style={{ paddingTop: 40, paddingBottom: 60 }}>
          ...
          <div className="contract-banner">
            ...
            <button
              ...
              onClick={() => {
                ...
                toast.success("Đã sao chép contract address");
              }}
            >
              Sao chép
            </button>
        ...
        {!loading && (
          <div className="grid-stats" style={{ marginBottom: 32 }}>
            <div className="stat-card">
              <div className="stat-icon" style={{ background: "#eef2ff" }}>Tx</div>
            ...
            <div className="stat-card">
              <div className="stat-icon" style={{ background: "#fffbeb" }}>ETH</div>
        ...
        <div className="card">
          <TransactionHistory transactions={transactions} loading={loading} title="" />
          {!loading && (
        ...
        <div className="card" style={{ marginTop: 24 }}>
          <h3 style={{ color: "#111827", marginBottom: 20, fontWeight: 700 }}>Thông Tin Blockchain</h3>
          <div className="blockchain-info">
            ...
            <div className="blockchain-row">
              ...
              <span className="blockchain-value">Pinata IPFS hoặc local fallback</span>
            </div>
            <div className="blockchain-row">
